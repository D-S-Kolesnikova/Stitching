...
private:
    ...
    string lightGluePath = "E:/devel/nets/superpoint/superpoint.ann";
public:
        ...
        , m_colorSchemes(colorSchemes)
    {
        *outputError = ESTNoError;
        ...
        else if (features_type == "SuperPoint")
        {
            ...
            finder = makePtr<SuperPoint>(lightGluePath, input_img);
        ...
        if (matcher_type == "LightGlue")
        {
            ...
            //matcher = x->getMatcher().dynamicCast<cv::Ptr<LightGlue>>();
        }
        else
        {
