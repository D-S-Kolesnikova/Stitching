...
{
    return CreateStitchingEngine(nFrames, direction, widths, heights, strides, colorSchemes, frameDataBGR, outputIntinsicCameraMatrix, outputRotationMatrix, ratio, netPath, outputError);
}
