...
constexpr auto JSON_POINT_MATCHING = "PointMatching";
...
const ArchitectureTypeMap_t ARCHITECTURE_MAP
{
    ...
    {"SuperPoint_LightGlue", ItvCv::ArchitectureType::SuperPoint_LightGlue},
...
const AnalyzerTypeMap_t NET_TYPES_MAP
{
    ...
    {"PointMatching", itvcvAnalyzerType::itvcvAnalyzerPointMatcher},
