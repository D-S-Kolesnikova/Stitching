...
template<>
struct MetadataJson<NodeType::PointMatchingParameters>
{
    static ItvCv::PointMatchingParams Parse(const Json::Value& networkParametersNode);
    static Json::Value Dump(const ItvCv::PointMatchingParams& pointMatchingNodeParams);
};
